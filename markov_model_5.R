...
markovmodel <- setRefClass("markovmodel", 
                           ...
                           methods = list(
                                               ...
                                               keep=4)
                               {
                                   ...
                                   if(is.null(three_gram) && is.null(two_gram) && is.null(four_gram) && is.null(five_gram)) {
                                       print("MODEL 1")
                                       f_numwords <<- 0
                                   ...
                                   else if(is.null(three_gram) && !is.null(two_gram) && is.null(four_gram) && is.null(five_gram)) {
                                       print("MODEL 2")
                                       f_numwords <<- 1
                                       # Store the one-gram in the field and
                                       # change the column name, sort with
                                   ...
                                   # WHen the model is setup to use 1- through 5-grams
                                       ...
                                       tryCatch({
                                           ...
                                           f_total_three <<- 
                                               sum(f_count_three$count)
                                           f_count_three$three_gram <<- row.names(f_count_three)
                                           f_count_three <<-  separate(f_count_three, 
                                                                       "three_gram", 
                                                                       c('first_word', 
                                                                         'second_word', 
                                                                         'third_word'), 
                                       ...
                                       tryCatch({
                                           ...
                                           f_count_four$four_gram <<- row.names(f_count_four)
                                           f_count_four <<-  separate(f_count_four, "four_gram", 
                                                                      c('first_word', 
                                                                        'second_word', 
                                                                        'third_word', 
                                                                        'fourth_word'), 
                                                                      sep='_')
                                           print(paste("four_gram column names: ", colnames(f_count_four)))
                                           print("four_gram head: ")
                                           print(head(f_count_four))
                                       },
                                       # warning = function(warn) {
                                       #     print(paste("MY WARNING: ", warn))
                                       # },
                                       ...
                                       tryCatch({
                                           ...
                                           f_count_five$five_gram <<- row.names(f_count_five)
                                           f_count_five <<-  separate(f_count_five, "five_gram", 
                                                                      c('first_word', 
                                                                        'second_word', 
                                                                        'third_word', 
                                                                        'fourth_word', 
                                                                        'fifth_word'), 
                                                                      sep='_')
                                           print(paste("five_gram column names: ", colnames(f_count_five)))
                                           print("five_gram head: ")
                                           print(head(f_count_five))
                                       },
                                       # warning = function(warn) {
                                       #     print(paste("MY WARNING: ", warn))
                                       # },
                               ...
                               predict = function(word1 = NULL, word2 = NULL)
                               {
                                   ...
                                   {
                                       predicted_list <- predict_5(word1, word2,
                                                                   word3, word4)
                                   }
                                   else
                                   {
                               ...
                               predict_3 = function(word1, word2)
                               {
                                   ...
                                   tryCatch({
                                       ...
                                       if(count_33_len < f_keep) {
                                           ...
                                           count_22 <- count_22 %>% arrange(desc(count_22$prob))
                                           ...
                                           dist <- dist %>% distinct(word, .keep_all = TRUE)
                               ...
                               predict_5 = function(word1, word2, word3, word4)
                               {
                                   # print("PREDICT FIVE")
                                   # print(paste("Words to find: ", word1, " and ", word2))
                                   tryCatch({
                                       # Get the list of 5-grams that start with the four words passed in
                                       count_5 <- filter(f_count_five, 
                                                         first_word == word1, 
                                                         second_word == word2, 
                                                         third_word == word3, 
                                                         fourth_word == word4)
                                       ...
                                       if(count_55_len < f_keep) {
                                           ...
                                           if(count_44_len < f_keep) {
                                               # Get the list of 3-grams that start with the two words passed in
                                               count_3 <- filter(f_count_three, first_word == word3, second_word == word4)
                                               # print(paste("count_3 colnames: ", colnames(count_3)))
                                               # print("count_3 Head: ")
                                               # print(head(count_3))
                                               count_word_first <- sum(count_3$count)
...
init_models <- function() {
    ...
    model5 <- markovmodel()
    model5$init(one_gram = totals_onegram, 
                two_gram = totals_2gram, 
                three_gram = totals_3gram, 
    ...
    model_list <- list("model_one" = model1, "model_two" = model2, "model_three" = model3, "model_five" = model5)
    return(model_list)
}
...
main <- function(){
   ...
   # print(model_list)
    ...
    # print(predicted_list)
    # 
    # predicted_list <- model_list$model_three$predict_3('heavy', 'cre')
    # print("Predicted List for Model 3:")
    # print(predicted_list)
    
    predicted_list <- model_list$model_five$predict('bring', 'a', 'case', 'of')
    print("Predicted List for Model 5:")
    print(predicted_list)
